...
class Work_Frame():
    ...
    # 获取指定工作坐标系tag, [position.x, position.y, position.z, euler.rx, euler.ry, euler.rz]
...
class Move_Plan():
    ...
    def Movep_CANFD(self, pose, follow):
        """
        Movep_CANFD 位姿不经规划，直接通过CANFD透传给机械臂
        :param pose: 末端位姿数组
        :param follow: 是否高跟随
        :return: 0-成功，失败返回:错误码, rm_define.h查询.
        """
