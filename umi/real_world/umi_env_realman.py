...
# from umi.real_world.wsg_controller_change               import WSGController
...
class UmiEnv:
    def __init__(self, 
        ...
        # 无需断言机器人的配置数量和夹具的配置数量相等
        # gripper: List[WSGController] = list()
