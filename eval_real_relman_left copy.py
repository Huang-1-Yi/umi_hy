...
@click.option('--frequency', '-f', default=10, type=float, help="Control frequency in Hz.")                 # 默认值为10Hz，用于指定控制频率
...
def main(input, output,robot_config,                                    # 输入的检查点路径、输出目录路径、机器人配置文件的路径
    ...
    max_gripper_width = 0.09                                            # 定义最大抓握宽度和抓握速度的变量，分别赋值为0.09m和0.2m/s
    gripper_speed = 0.2
